...
MODEL_PATH = os.path.join(BASE_DIR, 'overfitted_mnist_model.pth')
...
def main():
    ...
    print("\nStarting Evaluation & Feature Extraction...")
    with torch.no_grad():
    ...
    plt.title('t-SNE Visualization of Penultimate Layer Features (Test Set)', fontsize=14, fontweight='bold')
    ...
    print(f"\nSuccess! All artifacts successfully saved to: {BASE_DIR}")
